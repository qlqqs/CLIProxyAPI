...
func (h *GeminiAPIHandler) GeminiModels(c *gin.Context) {
	rawModels := handlers.AvailableModelsForContext(handlers.RequestContext(c), "gemini")
...
func (h *GeminiAPIHandler) GeminiGetHandler(c *gin.Context) {
	...
	availableModels := handlers.AvailableModelsForContext(handlers.RequestContext(c), "gemini")
